...
public class SimpleDhtDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + SimpleDhtContract.KeyValueEntry.TABLE_NAME + " (" +
                    SimpleDhtContract.KeyValueEntry.COLUMN_NAME_KEY + " TEXT PRIMARY KEY, " +
                    SimpleDhtContract.KeyValueEntry.COLUMN_NAME_VALUE + " TEXT)";


    private static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + SimpleDhtContract.KeyValueEntry.TABLE_NAME;
